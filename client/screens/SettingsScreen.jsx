...
import { StyleSheet, Text, View, SafeAreaView, Pressable, Switch, ScrollView } from 'react-native';
...
const CleanLogButton = (props) => (
    <Pressable {...props} style={({ pressed }) => [
        pressed ? styles.cleanBtnPressIn : styles.cleanBtnPressOut, styles.cleanBtn
    ]}>
        <Ionicons name="trash-outline" size={15} color={colors.dark}/>
...
export default () => {
    ...
    const [items, setItems] = useState([{label: 'English', value: 'eng'}, {label: 'Russian', value: 'ru'}]);
        ...
        <SafeAreaView>
            <View style={styles.container}>
                ...
                <View style={styles.rowContainer}>
                    <View style={styles.settingsRowTitle}>
                        <View style={styles.settingsRowTitleWrap}>
                            <Ionicons name="moon-outline" size={18} color={colors.dark}/>
                ...
                <View style={styles.rowContainer}>
                    <View style={styles.settingsRowTitle}>
                        <View style={styles.settingsRowTitleWrap}>
                            <Ionicons name="language-outline" size={18} color={colors.dark}/>
                ...
                <ScrollView style={styles.logContainer}>
                    {
                        getRecords().map((logs, i) => (
                            <Text style={styles.logRecord} key={i}>{logs.dt}: {logs.record}</Text>
                        ))
                    }
                </ScrollView>
            </View>
